...
var _creatNextStepObjectJs = require("./utils/model/creatNextStepObject.js");
...
function jQueryToJs($elements, errorMessage = "[not-findable]") {
    // Guard
...
exports.default = function($this, formBlockIndex) {
    ...
    elements.backButtons = (0, _helperJs.jQueryToJs)(elements.$backButton, '[not-findable = "Back Buttons"]');
    elements.nextButtons = (0, _helperJs.jQueryToJs)(elements.$nextButton, '[not-findable = "Next Buttons"]');
    elements.$progressBar = elements.$formBlock.find(_configJs.PROGRESS_BAR_SELECTOR);
    elements.progressBars = (0, _helperJs.jQueryToJs)(elements.$progressBar, '[not-findable = "Progress Bars"]');
...
},{"../../config.js":"k5Hzs","./autoDeleteConditionallyInvisibleElements.js":"eRaF0","../../helper.js":"lVRAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eRaF0":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../config.js":"k5Hzs","../../helper.js":"lVRAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9TJez":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../../config.js");
...
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../config.js");
var _stepRequirementsPassedJs = require("../utils/view/logics/stepRequirementsPassed.js");
var _stepRequirementsPassedJsDefault = parcelHelpers.interopDefault(_stepRequirementsPassedJs);
var _animateStepTransitionJs = require("../utils/view/visuals/animateStepTransition.js");
var _animateStepTransitionJsDefault = parcelHelpers.interopDefault(_animateStepTransitionJs);
var _selectButtonJs = require("../utils/view/visuals/selectButton.js");
...
var _removeOtherStepsJs = require("../utils/view/logics/removeOtherSteps.js");
var _removeOtherStepsJsDefault = parcelHelpers.interopDefault(_removeOtherStepsJs);
var _initQuizModeJs = require("../utils/view/logics/initQuizMode.js");
var _initQuizModeJsDefault = parcelHelpers.interopDefault(_initQuizModeJs);
var _performVisualSubmitJs = require("../utils/view/visuals/performVisualSubmit.js");
...
class StepView {
    ...
    #findNext(stateData, triggeredBySwipe) {
        ...
        // If no button exists
        const $currentStepButtons = $currentStep.find(`[${_configJs.CLICK_ELEMENT_ID_ATTRIBUTE}]`);
        if ($currentStepButtons.length === 0) {
            if ((0, _stepRequirementsPassedJsDefault.default)(stateData.elements.$formBlock, $currentStep)) this.#goToNext(stateData, currentStepId, null);
        }
    }
    // - Update next button -
    ...
    #goToNext(stateData2, stepIndex, buttonIndex) {
        ...
        let nextStepId;
        // If no buttons exist
        if (buttonIndex === null) // if last
        {
            if (!stateData2.stepLogic[stepIndex].isLast) nextStepId = stepIndex + 1;
        } else // Variable
        nextStepId = stateData2.stepLogic[stepIndex].buttons[buttonIndex].nextStepId;
    ...
    #submitForm(stateData4) {
        ...
        // Slider mode
        if (stateData4.sliderMode) return;
        // Request
...
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../../../config.js");
var _errorStatusJs = require("../visuals/errorStatus.js");
...
},{"../../../config.js":"k5Hzs","../visuals/errorStatus.js":"liPth","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"liPth":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _modelJs = require("../../../model.js");
...
exports.default = function(mode = "add", $elements, styleIndex) {
    // Variables
    const stateData = _modelJs.state.data[`form${styleIndex}`], styles = stateData.styles, cssErrorStatus = styles["cssErrorStatus"], cssErrorStatusResolved = styles["cssErrorStatusResolved"], elements = (0, _helperJs.jQueryToJs)($elements, '[not-findable = "errorStatus.js -> $elements"]');
    // Action
...
},{"../../../model.js":"Y4A21","../../../helper.js":"lVRAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2CMDR":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../../../config.js");
...
},{"../../../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fgxev":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../../../config.js");
...
},{"../../../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dMf2e":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../../../config.js");
...
},{"../../../config.js":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fnC3X":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../../../config.js");
...
},{"../../../config.js":"k5Hzs","../../../model.js":"Y4A21","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iWahp":[function(require,module,exports) {
// + Imports +
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../config.js");
var _defineSwipeTypeJs = require("../utils/view/logics/defineSwipeType.js");
